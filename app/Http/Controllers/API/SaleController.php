...

{
    ...
    public function create(Request $req){
        ...
        public function region_wise_sale() {
            ...
            $final_array = [
                [isset($sindhTotalUnitByCategory['Lips']) ? $sindhTotalUnitByCategory['Lips'] : 0 ,isset($sindhTotalUnitByCategory['Face']) ? $sindhTotalUnitByCategory['Face'] : 0 ,   isset($sindhTotalUnitByCategory['Nails']) ? $sindhTotalUnitByCategory['Nails'] : 0 ,isset($sindhTotalUnitByCategory['Eyes']) ? $sindhTotalUnitByCategory['Eyes'] : 0, $sindhTotalUnits],
                [isset($punjabTotalUnitByCategory['Lips']) ? $punjabTotalUnitByCategory['Lips'] : 0 ,isset($punjabTotalUnitByCategory['Face']) ? $punjabTotalUnitByCategory['Face'] : 0 , isset($punjabTotalUnitByCategory['Nails']) ? $punjabTotalUnitByCategory['Nails'] : 0 ,isset($punjabTotalUnitByCategory['Eyes']) ? $punjabTotalUnitByCategory['Eyes'] : 0, $punjabTotalUnits ],
                [isset($totalPriceByCategory['Lips']) ? $totalPriceByCategory['Lips'] : 0,isset($totalPriceByCategory['Face']) ? $totalPriceByCategory['Face'] : 0,            isset($totalPriceByCategory['Nails']) ? $totalPriceByCategory['Nails'] : 0,isset($totalPriceByCategory['Eyes']) ? $totalPriceByCategory['Eyes'] : 0, $totalPrice ],
                [isset($totalUnitByCategory['Lips']) ? $totalUnitByCategory['Lips'] : 0,isset($totalUnitByCategory['Face']) ? $totalUnitByCategory['Face'] : 0,              isset($totalUnitByCategory['Nails']) ? $totalUnitByCategory['Nails'] : 0,isset($totalUnitByCategory['Eyes']) ? $totalUnitByCategory['Eyes'] : 0, $totalUnits]
            ];
